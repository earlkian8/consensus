        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <motion.div initial="hidden" animate="visible" variants={fadeUp}>
            ...
            <p className="text-muted-foreground text-base leading-relaxed mb-8 max-w-lg">
              Consensus is an AI-powered food excess management system that
              helps commercial kitchens plan smarter, track production in real
              time, and turn waste data into actionable insights.
            </p>
            <Link to="/dashboard">
        ...
        <div className="relative max-w-6xl mx-auto px-6 py-16">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-xl mx-auto">
              Food waste is a massive global issue — and commercial kitchens are
              a major contributor. Most excess happens because of poor planning,
              not carelessness.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                prefix: "P",
                suffix: "T+",
                label: "Annual economic losses from food waste worldwide",
                color: "text-destructive",
              },
              {
                icon: AlertTriangle,
                value: "30",
                suffix: "-40%",
                label: "Of food in commercial kitchens becomes excess",
                color: "text-destructive",
              },
            ].map((stat, i) => (
              <motion.div
          ...
          >
            <p className="text-sm text-muted-foreground max-w-lg mx-auto">
              The root cause? Kitchens rely on guesswork for production
              quantities. Without data, they overproduce to avoid running out —
              creating consistent, preventable waste.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 py-20">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-lg mx-auto">
            Consensus provides a complete toolkit for managing food production
        ...
        <div className="max-w-6xl mx-auto px-6 py-20">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-md mx-auto">
              A continuous improvement cycle in four steps.
            </p>
          </motion.div>
            ...
            {[
              {
                step: "1",
                title: "Catalog",
                desc: "Add your kitchen products with batch sizes and units",
              },
              {
                step: "2",
                title: "Plan",
                desc: "Create a production plan, set quantities and end time",
              },
              {
                step: "3",
                title: "Produce",
                desc: "Run a timed session and serve your customers",
              },
              {
                step: "4",
                title: "Audit",
                desc: "Log excess, get AI recommendations for next time",
              },
            ].map((item, i) => (
              <motion.div
                key={item.step}
          ...
          <motion.p
            ...
            variants={fadeUp}
          >
            Each cycle feeds data back into the system. Over time, AI
            recommendations become more accurate, driving continuous waste
            reduction.
          </motion.p>
        </div>
      </section>
      ...
      <section className="relative border-y border-border overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-6 py-20">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-lg mx-auto">
              Any kitchen that produces food at scale can benefit from
            ...
            {[
              {
                icon: Utensils,
                title: "Restaurants",
                desc: "Reduce daily overproduction and cut food costs",
              },
              {
                icon: Building2,
                title: "Catering",
                desc: "Plan event quantities with precision",
              },
              {
                icon: Store,
                title: "Canteens",
                desc: "Match output to actual headcount patterns",
              },
              {
                icon: Truck,
                title: "Cloud Kitchens",
                desc: "Optimize multi-brand production runs",
              },
            ].map((item, i) => (
              <motion.div
                key={item.title}
            ...
            {[
              {
                icon: DollarSign,
                title: "Cut costs",
                desc: "Reduce raw material waste and save on procurement",
              },
              {
                icon: Leaf,
                title: "Reduce environmental impact",
                desc: "Less food waste means lower carbon emissions",
              },
              {
                icon: Users,
                title: "Enable redistribution",
                desc: "Identify surplus early enough to donate instead of discard",
              },
            ].map((benefit) => (
              <div
                key={benefit.title}
